...
def is_likely_original(album_name, album_type):
    ...
    rerelease_keywords = [
        'remaster', 'live', 'compilation', 'deluxe', 'edition', 
        'greatest hits', 'best of', 'collection', 'anthology',
        'live at', 'recorded live', 'concert', 'sessions',
        're-release', 'anniversary', 'expanded', 'bonus',
        'soundtrack', 'karaoke', 'tribute', 'covers'
    ]
...
# Read the CSV file
df = pd.read_csv('songs.csv')  # Replace with your file name
